...
byte regPairIdx[] = { 0x82, 0x88, 0x8C, 0x90 }; /* psw b d h */
...
byte b47A0[] = { 0,    4,    8,    0xC,  0x10, 0x14, 0x18, 0x1C, 0x20, 0x24, 0x28,
...
word w4919[] = { 0x134, 0x137, 0x13F, 0x142, 0x14A, 0x14D, 0x151, 0x15A, 0x15C, 0x15F, 0x161, 0x14A,
...
byte b4A03[] = { 0xB,  8,    0xB, 8,    0x10, 0xD, 9,    0x10, 0xE, 0xB,  9,   0x10, 0xD,
...
static void EmitLocalLabel() {
    ...
    sprintf(locLabStr, "@%d", locLabelNum);
    EmitLabel(locLabStr);
}
