...
class address {
  ...
  protected:
    ...
    void setloc(address n) {
        loc = n.getloc();
    }
    void setaddr(void *p) {
        loc = word((Byte *)p - memory);
    }
    word getloc() {
        return loc;
    }
  ...
  public:
    ...
    address &operator=(address n) {
        loc = n.getloc();
        return *this;
    }
    address &operator=(void *p) {
        loc = word((Byte *)p - memory);
        return *this;
    }
    operator word() {
    ...
    operator char *() {
        return (char *)(memory + loc);
    }
    operator void *() {
        return (void *)(memory + loc);
    }
    operator word *() {
        return (word *)(memory + loc);
    }
    word *operator&() {
        return &loc;
    }
    address operator+(word n) {
        return loc + n;
    }
    address operator+(int n) {
        return loc + n;
    ...
    operator symbol_pt *() {
        return (symbol_pt *)(memory + loc);
    }
    bool operator==(address n) {
        return loc == n.getloc();
    }
    bool operator<(address n) {
        return loc < n.getloc();
...
class cmdLine_pt : public address {
  public:
    cmdLine_t *operator->() {
        return (cmdLine_t *)getaddr();
    }
    cmdLine_pt operator=(cmdLine_pt n) {
        setloc(n.getloc());
        return *this;
    }
    bool operator!=(int n) {
...
class info_pt : public address {
  public:
    ...
    info_pt operator=(int n) {
        setloc(n);
        return *this;
    }
    info_pt operator=(address n) {
        setloc(word(n));
        return *this;
    }
    info_t *operator->() {
        return (info_t *)getaddr();
    }
    bool operator!=(address n) {
        return getloc() != word(n);
    }
    bool operator!=(int n) {
        return getloc() != n;
    }
...
class symbol_pt : public address {
  public:
    ...
    symbol_pt &operator=(int n) {
        setloc(n);
        return *this;
    }
    bool operator!=(symbol_pt n) {
        return getloc() != n.getloc();
    }
    bool operator!=(int n) {
        return getloc() != n;
    }
    symbol_t *operator->() {
        return (symbol_t *)getaddr();
    }
    bool operator==(symbol_pt n) {
        return getloc() == n.getloc();
    }
...
inline word info2Off(word val) {
    return val - botInfo;
}
inline address off2Info(word val) {
    return botInfo + val;
}
