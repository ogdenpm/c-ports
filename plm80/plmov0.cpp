/****************************************************************************
 *  plmov0.cpp: part of the C port of Intel's ISIS-II plm80             *
...
void sub_3EDF() {
    ...
    backupPos((loc_t *)&srcFileTable[srcFileIdx].block, (word)(inOffLastCh - inOffCurCh));
    closeFile(&srcFile);
}
...
Byte cClass[]     = { CC_NONPRINT, CC_NONPRINT,  CC_NONPRINT, CC_NONPRINT, // 0
                      CC_NONPRINT, CC_NONPRINT,  CC_NONPRINT, CC_NONPRINT, CC_NONPRINT, CC_WSPACE,
                      CC_NEWLINE,  CC_NONPRINT,  CC_NONPRINT, CC_WSPACE,   CC_NONPRINT, CC_NONPRINT,
                      CC_NONPRINT, CC_NONPRINT,  CC_NONPRINT, CC_NONPRINT, // 10
                      CC_NONPRINT, CC_NONPRINT,  CC_NONPRINT, CC_NONPRINT, CC_NONPRINT, CC_NONPRINT,
                      CC_NONPRINT, CC_NONPRINT,  CC_NONPRINT, CC_NONPRINT, CC_NONPRINT, CC_NONPRINT,
                      CC_WSPACE,   CC_INVALID,   CC_INVALID,  CC_INVALID, // 20
                      CC_DOLLAR,   CC_INVALID,   CC_INVALID,  CC_QUOTE,    CC_LPAREN,   CC_RPAREN,
                      CC_STAR,     CC_PLUS,      CC_COMMA,    CC_MINUS,    CC_PERIOD,   CC_SLASH,
                      CC_BINDIGIT, CC_BINDIGIT,  CC_OCTDIGIT, CC_OCTDIGIT, // 30
                      CC_OCTDIGIT, CC_OCTDIGIT,  CC_OCTDIGIT, CC_OCTDIGIT, CC_DECDIGIT, CC_DECDIGIT,
                      CC_COLON,    CC_SEMICOLON, CC_LESS,     CC_EQUALS,   CC_GREATER,  CC_INVALID,
                      CC_INVALID,  CC_HEXCHAR,   CC_HEXCHAR,  CC_HEXCHAR, // 40
                      CC_HEXCHAR,  CC_HEXCHAR,   CC_HEXCHAR,  CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA, // 50
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_INVALID,   CC_INVALID,  CC_INVALID,  CC_INVALID,  CC_INVALID,
                      CC_INVALID,  CC_HEXCHAR,   CC_HEXCHAR,  CC_HEXCHAR, // 60
                      CC_HEXCHAR,  CC_HEXCHAR,   CC_HEXCHAR,  CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA, // 70
                      CC_ALPHA,    CC_ALPHA,     CC_ALPHA,    CC_ALPHA,    CC_ALPHA,    CC_ALPHA,
                      CC_ALPHA,    CC_INVALID,   CC_INVALID,  CC_INVALID,  CC_INVALID,  CC_NONPRINT };

Byte tok2oprMap[] = { L_VARIABLE, L_NUMBER,  L_STRING,    L_PLUSSIGN,    L_MINUSSIGN, L_STAR,
                      L_SLASH,    L_MOD,     L_PLUS,      L_MINUS,       L_AND,       L_OR,
                      L_XOR,      L_NOT,     L_XREF,      L_LT,          L_LE,        L_EQ,
...
Byte controls[] = {
    5,    'P',  'R', 'I',  'N',  'T',  0,   0,    0xFF, 7,    0,    7,    'N',  'O', 'P',  'R',
    'I',  'N',  'T', 0,    0,    0xFF, 8,   0,    4,    'L',  'I',  'S',  'T',  3,   1,    0,
    0,    0,    6,   'N',  'O',  'L',  'I', 'S',  'T',  4,    1,    0,    0,    0,   4,    'C',
    'O',  'D',  'E', 5,    1,    0,    0,   0,    6,    'N',  'O',  'C',  'O',  'D', 'E',  6,
    1,    0,    0,   0,    4,    'X',  'R', 'E',  'F',  0,    0,    1,    1,    1,   6,    'N',
    'O',  'X',  'R', 'E',  'F',  0,    0,   1,    0,    1,    7,    'S',  'Y',  'M', 'B',  'O',
    'L',  'S',  0,   0,    2,    1,    2,   9,    'N',  'O',  'S',  'Y',  'M',  'B', 'O',  'L',
    'S',  0,    0,   2,    0,    2,    5,   'D',  'E',  'B',  'U',  'G',  0,    0,   3,    1,
    3,    7,    'N', 'O',  'D',  'E',  'B', 'U',  'G',  0,    0,    3,    0,    3,   6,    'P',
    'A',  'G',  'I', 'N',  'G',  0,    0,   4,    1,    4,    8,    'N',  'O',  'P', 'A',  'G',
    'I',  'N',  'G', 0,    0,    4,    0,   4,    0xA,  'P',  'A',  'G',  'E',  'L', 'E',  'N',
    'G',  'T',  'H', 0,    0,    0xFF, 0,   5,    9,    'P',  'A',  'G',  'E',  'W', 'I',  'D',
    'T',  'H',  0,   0,    0xFF, 1,    6,   4,    'D',  'A',  'T',  'E',  0,    0,   0xFF, 2,
    7,    5,    'T', 'I',  'T',  'L',  'E', 0,    0,    0xFF, 3,    8,    5,    'E', 'J',  'E',
    'C',  'T',  7,   1,    0,    0,    0,   0xA,  'L',  'E',  'F',  'T',  'M',  'A', 'R',  'G',
    'I',  'N',  0,   1,    0xFF, 4,    0,   6,    'O',  'B',  'J',  'E',  'C',  'T', 0,    0,
    0xFF, 5,    9,   8,    'N',  'O',  'O', 'B',  'J',  'E',  'C',  'T',  0,    0,   0xFF, 9,
    9,    8,    'O', 'P',  'T',  'I',  'M', 'I',  'Z',  'E',  0,    0,    6,    1,   0xA,  0xA,
    'N',  'O',  'O', 'P',  'T',  'I',  'M', 'I',  'Z',  'E',  0,    0,    6,    0,   0xA,  7,
    'I',  'N',  'C', 'L',  'U',  'D',  'E', 0,    1,    0xFF, 6,    0,    9,    'W', 'O',  'R',
    'K',  'F',  'I', 'L',  'E',  'S',  0,   0,    0xFF, 0xA,  0xB,  9,    'I',  'N', 'T',  'V',
    'E',  'C',  'T', 'O',  'R',  0,    0,   0xFF, 0xB,  0xC,  0xB,  'N',  'O',  'I', 'N',  'T',
    'V',  'E',  'C', 'T',  'O',  'R',  0,   0,    0xFF, 0xC,  0xC,  5,    'I',  'X', 'R',  'E',
    'F',  0,    0,   0xFF, 0xD,  0xD,  7,   'N',  'O',  'I',  'X',  'R',  'E',  'F', 0,    0,
    0xFF, 0xE,  0xD, 4,    'S',  'A',  'V', 'E',  0,    1,    0xFF, 0xF,  0,    7,   'R',  'E',
    'S',  'T',  'O', 'R',  'E',  0,    1,   0xFF, 0x10, 0,    3,    'S',  'E',  'T', 0,    1,
    0xFF, 0x11, 0,   5,    'R',  'E',  'S', 'E',  'T',  0,    1,    0xFF, 0x12, 0,   2,    'I',
    'F',  0,    1,   0xFF, 0x13, 0,    6,   'E',  'L',  'S',  'E',  'I',  'F',  0,   1,    0xFF,
    0x14, 0,    4,   'E',  'L',  'S',  'E', 0,    1,    0xFF, 0x14, 0,    5,    'E', 'N',  'D',
    'I',  'F',  0,   1,    0xFF, 0x15, 0,   4,    'C',  'O',  'N',  'D',  0,    1,   0xFF, 0x16,
    0,    6,    'N', 'O',  'C',  'O',  'N', 'D',  0,    1,    0xFF, 0x17, 0,    0
};
...
void nxtCh() {
    ...
    if ((chrClass = cClass[*(Byte *)curCh_p]) == CC_NONPRINT)
        *curCh_p = ' ';
...
word asc2Num(char *firstch, char *lastch, Byte radix) {
    ...
    while (firstch <= lastch) {
        if (cClass[*(Byte *)firstch] <= CC_DECDIGIT) // digits
            digit = *firstch - '0';
        else if (cClass[*(Byte *)firstch] < CC_ALPHA) // hex digits
            digit = *firstch - 'A' + 10;
        else
            return 0xffff;
        if (digit >= radix)
...
void optIntVector() {
    ...
    if (*curCh_p != '(')
        ...
        if (vecInterval != 4 && vecInterval != 8) {
            ...
            skipToRPARorEOL();
        } else if ((vecLoc = parseNum()) > 0xffe0 || vecLoc % (vecInterval * 8) != 0 ||
                   *curCh_p != ')') {
            badCmdTail(ERR177); // INVALID INTVECTOR LOCATION VALUE
            skipToRPARorEOL();
        } else {
...
void findOption() {
    ...
    for (clen = controls[0]; clen; clen = controls[off]) {
        if (tknLen == clen && strncmp(optStrVal_p, (char *)&controls[off + 1], (Byte)clen) == 0) {
...
Byte tokenTypeTable[] = {
    T_NUMBER, T_NUMBER, T_NUMBER, T_VARIABLE, T_VARIABLE, T_PLUSSIGN,  T_MINUSSIGN, T_STAR,
    T_SLASH,  T_LPAREN, T_RPAREN, T_COMMA,    T_COLON,    T_SEMICOLON, T_STRING,    T_PERIOD,
    T_EQ,     T_LT,     T_GT,     T_VARIABLE, T_VARIABLE, T_VARIABLE,  T_VARIABLE,  T_VARIABLE
};
...
void token2Num() {
    if (cClass[l5bcd_ch = tokenStr[l5bcd_toklen = *tokenStr]] <=
        CC_DECDIGIT) // last char is a digit
...
void sub_63B7(word val) {
    ...
    if (declaringBase != 0) {
        if (testInfoFlag(F_PUBLIC) || testInfoFlag(F_EXTERNAL) || testInfoFlag(F_AT) ||
            testInfoFlag(F_INITIAL) || testInfoFlag(F_DATA)) {
            sub_62B0(ERR81); // CONFLICTING ATTRIBUTE WITH 'BASE'
            declaringBase = 0;
        } else
            setInfoFlag(F_BASED);
...
void sub_6A68() {
    ...
    if (basedInfo == 0)
        return;
    curInfo_p = basedInfo;
    if (testInfoFlag(F_BASED) || testInfoFlag(F_ARRAY) || getInfoType() != ADDRESS_T) {
...
Byte brkTxiCodes[] = {
    ...
    L_STATEMENT, L_SEMICOLON, L_CALL, L_LINEINFO, L_DISABLE, L_DO,        L_ENABLE,
    L_END,       L_GO,        L_GOTO, L_HALT,     L_IF,      L_PROCEDURE, L_RETURN
};
...
void state19() { // check for DECLARE or PROCEDURE
...
void state5() {
    ...
    if (stmtStartCode == (T_END - T_CALL + 2)) {
        ...
        if (stmtStartCode == (T_DECLARE - T_CALL + 2)) {
            ...
            if (stmtStartCode == (T_PROCEDURE - T_CALL + 2) || stmtStartCode == (T_DO - T_CALL + 2))
                pushStateByte(7);
            else
                skipToSemiColon();
        }
...
void state11() {
    if (stmtStartCode == (T_DECLARE - T_CALL + 2) || stmtStartCode == (T_PROCEDURE - T_CALL + 2) ||
...
void state14() { // process CASE statements
    word stateWord;
    symbol_pt labelptr;
...
void state17() { // process optional ELSE
    word stateWord;
    Byte tmp;
