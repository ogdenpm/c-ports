...
uint8_t resword[333] = {
    12,  0,   0,   'E', 'O', 'F', 0,   13,  0,   0,   'D', 'E', 'C', 'L', 'A', 'R', 'E', 0,   14,
    0,   0,   'I', 'N', 'I', 'T', 'I', 'A', 'L', 0,   15,  0,   0,   'E', 'N', 'D', 0,   16,  0,
    0,   'I', 'F', 0,   17,  0,   0,   'T', 'H', 'E', 'N', 0,   18,  0,   0,   'E', 'L', 'S', 'E',
    0,   19,  0,   0,   'Z', 'E', 'R', 'O', 0,   20,  0,   0,   'C', 'Y', 0,   21,  0,   0,   'P',
    'Y', 0,   22,  0,   0,   'O', 'D', 'D', 0,   23,  0,   0,   'E', 'V', 'E', 'N', 0,   24,  0,
    0,   'P', 'L', 'U', 'S', 0,   25,  0,   0,   'M', 'I', 'N', 'U', 'S', 0,   26,  0,   0,   'D',
    'A', 'T', 'A', 0,   27,  0,   0,   'B', 'Y', 'T', 'E', 0,   28,  0,   0,   'L', 'A', 'B', 'E',
    'L', 0,   29,  0,   0,   'E', 'X', 'T', 'E', 'R', 'N', 'A', 'L', 0,   30,  0,   0,   'C', 'O',
    'M', 'M', 'O', 'N', 0,   31,  0,   0,   'D', 'O', 0,   32,  0,   0,   'B', 'Y', 0,   33,  0,
    0,   'W', 'H', 'I', 'L', 'E', 0,   34,  0,   0,   'C', 'A', 'S', 'E', 0,   35,  0,   0,   'P',
    'R', 'O', 'C', 'E', 'D', 'U', 'R', 'E', 0,   36,  0,   0,   'R', 'E', 'T', 'U', 'R', 'N', 0,
    37,  0,   0,   'C', 'A', 'L', 'L', 0,   38,  0,   0,   'G', 'O', 'T', 'O', 0,   39,  0,   0,
    'H', 'L', 0,   40,  0,   0,   'U', 'N', 'T', 'I', 'L', 0,   41,  0,   0,   'R', 'E', 'P', 'E',
    'A', 'T', 0,   42,  0,   0,   'H', 'A', 'L', 'T', 0,   43,  0,   0,   'N', 'O', 'P', 0,   44,
    0,   0,   'D', 'I', 'S', 'A', 'B', 'L', 'E', 0,   45,  0,   0,   'E', 'N', 'A', 'B', 'L', 'E',
    0,   46,  0,   0,   'B', 'C', 0,   47,  0,   0,   'D', 'E', 0,   48,  0,   0,   'S', 'P', 0,
    49,  0,   0,   'S', 'T', 'A', 'C', 'K', 0,   50,  0,   0,   'P', 'S', 'W', 0,   51,  0,   0,
    'I', 'N', 0,   52,  0,   0,   'O', 'U', 'T', 0
};
