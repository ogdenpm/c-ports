/****************************************************************************
 *l81tab.c: part of the C port of l81 high level assembler lexer and parser *
...
uint16_t lract[] = {
    0,
    /*  0*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN), S(23), M(TT_CALL),
    S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT), S(41), M(TT_HALT),
    S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC), S(43), M(TT_DE),
    S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53), M(TT_OUT), S(54),
    0,
    /*  1*/ M(0), 0x4000, 0,
    /*  2*/ M(';'), S(55), 0,
    /*  3*/ R(2),
    ...
    /* 16*/ R(16),
    /* 17*/ R(17),
    /* 18*/ M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE), S(20), M(TT_IF),
    S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_PROCEDURE), S(59), M(TT_RETURN), S(23),
    M(TT_CALL), S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT), S(41),
    M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC), S(43),
    M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    M(TT_OUT), S(54), 0,
    /* 19*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN), S(23), M(TT_CALL),
    S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT), S(41), M(TT_HALT),
    S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC), S(43), M(TT_DE),
    S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53), M(TT_OUT), S(54),
    ...
    /* 22*/
    /* 28*/
    /* 76*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN), S(23), M(TT_CALL),
    S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT), S(41), M(TT_HALT),
    S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC), S(43), M(TT_DE),
    S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53), M(TT_OUT), S(54),
    0,
    /* 23*/ R(90),
    /* 24*/ M('('), S(76), M('!'), S(78), M(TT_ZERO), S(79), M(TT_CY), S(80), M(TT_PY), S(81),
    M(TT_PLUS), S(82), M(TT_MINUS), S(83), 0,
    ...
    /* 31*/ R(109),
    /* 32*/ R(110),
    /* 33*/ M(TT_SWAP), S(93), M(TT_CMP), S(92), M('='), S(94), 0,
    /* 34*/ R(28),
    /* 35*/ M(','), S(95), R(29),
    /* 36*/ M('('), S(97), M(':'), S(96), R(154),
    /* 37*/ M(':'), S(98), 0,
    /* 38*/ M(IDENTIFIER), S(105), M(ASL), S(42), M(';'), R(73), M(TT_CY), S(50), M(TT_CASE),
    S(102), M('M'), S(49), M(TT_HL), S(45), M(TT_BC), S(43), M(TT_DE), S(44), M(TT_SP), S(46),
    M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53), M(TT_OUT), S(54), R(26),
    ...
    /* 53*/ M('('), S(113), 0,
    /* 54*/ M('('), S(114), 0,
    /* 55*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_EOF),
    S(115), M(TT_DECLARE), S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN),
    S(23), M(TT_CALL), S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT),
    S(41), M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC),
    S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    M(TT_OUT), S(54), 0,
    /* 57*/ R(18),
    /* 58*/ R(19),
    /* 59*/ R(86),
    /* 60*/ R(32),
    /* 61*/
    /*212*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN), S(23), M(TT_CALL),
    S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT), S(41), M(TT_HALT),
    S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC), S(43), M(TT_DE),
    S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53), M(TT_OUT), S(54),
    ...
    /* 65*/ M('('), S(125), M(TT_BYTE), S(124), M(TT_LABEL), S(126), M(TT_EXTERNAL), S(127),
    M(TT_COMMON), S(128), 0,
    /* 66*/ M(TT_DATA), S(131), R(65),
    /* 67*/ M(NUMBER), S(132), 0,
    /* 68*/ M(IDENTIFIER), S(133), 0,
    /* 69*/ R(67),
    /* 70*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_END), S(136), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN),
    S(23), M(TT_CALL), S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT),
    S(41), M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC),
    S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    M(TT_OUT), S(54), 0,
    ...
    /* 73*/ M('&'), S(140), M('\\'), S(141), M(TT_RETURN), S(142), M(TT_CALL), S(143), M(TT_GOTO),
    S(144), R(38),
    /* 74*/
    /* 75*/ M('('), S(76), M('!'), S(78), M(TT_ZERO), S(79), M(TT_CY), S(80), M(TT_PY), S(81),
    M(TT_PLUS), S(82), M(TT_MINUS), S(83), 0,
    /* 77*/ R(44),
    ...
    /* 87*/
    /*121*/
    /*130*/ M(NUMBER), S(155), M(STRING), S(154), M('-'), S(156), M('.'), S(157), 0,
    /* 88*/ R(100),
    /* 89*/ R(101),
    /* 90*/ M('('), S(158), 0,
    /* 91*/ M(';'), S(159), 0,
    /* 92*/
    /*177*/
    /*223*/ M(NUMBER), S(155), M(STRING), S(154), M(ASL), S(42), M('('), S(164), M(TT_CY), S(50),
    M('M'), S(165), M(TT_HL), S(45), M('-'), S(156), M('.'), S(157), M(TT_BC), S(43), M(TT_DE),
    S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), 0,
    /* 93*/
    /*112*/ M(ASL), S(42), M('('), S(164), M(TT_CY), S(50), M('M'), S(165), M(TT_HL), S(45),
    M(TT_BC), S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), 0,
    /* 94*/ M(IDENTIFIER), S(105), M(NUMBER), S(155), M(STRING), S(154), M(ASL), S(42), M(TT_RRC),
    S(175), M(TT_RLC), S(176), M('('), S(164), M('!'), S(173), M(TT_CY), S(50), M('M'), S(49),
    M(TT_HL), S(45), M('-'), S(156), M('.'), S(157), M(TT_BC), S(43), M(TT_DE), S(44), M(TT_SP),
    S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M('<'), S(171), M('>'), S(172), M('#'), S(174),
    M(TT_IN), S(53), M(TT_OUT), S(54), 0,
    /* 95*/ M(TT_ADC), S(183), M(TT_SBB), S(184), M(TT_XOR), S(182), M('&'), S(180), M('\\'),
    S(181), M('-'), S(179), M('+'), S(178), 0,
    /* 96*/ R(30),
    /* 97*/ M(NUMBER), S(185), 0,
    /* 98*/ R(31),
    /* 99*/ R(74),
    ...
    /*102*/ M(ASL), S(42), M(TT_CY), S(50), M('M'), S(165), M(TT_HL), S(45), M(TT_BC), S(43),
    M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), 0,
    /*103*/ R(27),
    /*104*/ M('='), S(94), 0,
    /*105*/ M('('), S(97), R(154),
    /*106*/ R(84),
    ...
    /*109*/ R(88),
    /*110*/ R(106),
    /*111*/ M(NUMBER), S(155), M(STRING), S(154), M(TT_HL), S(193), M('-'), S(156), M('.'), S(157),
    M(TT_BC), S(194), M(TT_DE), S(195), 0,
    ...
    /*137*/ M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE), S(20), M(TT_END),
    S(136), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_PROCEDURE), S(59), M(TT_RETURN),
    S(23), M(TT_CALL), S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT),
    S(41), M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC),
    S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    M(TT_OUT), S(54), 0,
    /*138*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_END), S(136), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN),
    S(23), M(TT_CALL), S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_REPEAT),
    S(41), M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC),
    S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    ...
    /*158*/ M(TT_HL), S(219), 0,
    /*159*/ M(YERROR), S(6), M(IDENTIFIER), S(36), M(NUMBER), S(37), M(ASL), S(42), M(TT_DECLARE),
    S(20), M(TT_IF), S(24), M(TT_CY), S(50), M(TT_DO), S(52), M(TT_RETURN), S(23), M(TT_CALL),
    S(40), M(TT_GOTO), S(27), M('M'), S(49), M(TT_HL), S(45), M(TT_UNTIL), S(220), M(TT_REPEAT),
    S(41), M(TT_HALT), S(29), M(TT_NOP), S(30), M(TT_DISABLE), S(31), M(TT_ENABLE), S(32), M(TT_BC),
    S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), M(TT_IN), S(53),
    M(TT_OUT), S(54), 0,
    /*160*/ R(111),
    ...
    /*162*/ R(123),
    /*163*/ R(114),
    /*164*/ M(ASL), S(42), M(TT_CY), S(50), M('M'), S(165), M(TT_HL), S(45), M(TT_BC), S(43),
    M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48), 0,
    /*165*/ M('('), S(222), 0,
    /*166*/ R(112),
    /*167*/ M(TT_ADC), S(183), M(TT_SBB), S(184), M(TT_XOR), S(182), M('&'), S(180), M('\\'),
    S(181), M('-'), S(179), M('+'), S(178), R(118),
    /*168*/ M(IDENTIFIER), S(105), M(NUMBER), S(155), M(STRING), S(154), M(ASL), S(42), M('('),
    S(164), M(TT_CY), S(50), M('M'), S(49), M(TT_HL), S(45), M('-'), S(156), M('.'), S(157),
    M(TT_BC), S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48),
    M(TT_IN), S(53), M(TT_OUT), S(54), 0,
    /*169*/ R(120),
    /*170*/ R(121),
    /*171*/ R(146),
    ...
    /*184*/ R(145),
    /*185*/ M(')'), S(226), 0,
    /*186*/ M(IDENTIFIER), S(105), M(ASL), S(42), M(TT_CY), S(50), M('M'), S(49), M(TT_HL), S(45),
    M(TT_BC), S(43), M(TT_DE), S(44), M(TT_SP), S(46), M(TT_STACK), S(47), M(TT_PSW), S(48),
    M(TT_IN), S(53), M(TT_OUT), S(54), 0,
    /*187*/
    /*220*/
    /*249*/ M('('), S(76), M('!'), S(78), M(TT_ZERO), S(79), M(TT_CY), S(80), M(TT_PY), S(81),
    M(TT_PLUS), S(82), M(TT_MINUS), S(83), 0,
    /*188*/ R(80),
    /*189*/ R(81),
    /*190*/ R(82),
    ...
    /*210*/ R(40),
    /*211*/ R(42),
    /*213*/ M('!'), S(78), M(TT_ZERO), S(79), M(TT_CY), S(80), M(TT_PY), S(81), M(TT_PLUS), S(82),
    M(TT_MINUS), S(83), 0,
    /*214*/ R(95),
    /*215*/ R(97),
    /*216*/ R(126),
...
uint16_t lrpact[] = { 0,     1,     0x34,  0x37,  0x3A,  0x3B,  0x3C,  0x3D,  /* 0 */
...
uint8_t llr1[160] = { 0,  1,  2,  2,  3,  3,  3,  4,  4,  4,   /* 0 */
...
uint8_t llr2[160] = { 0, 3, 1, 3, 1, 1, 1, 1, 1, 1,   /* 0 */
...
uint8_t lrpgo[63] = { 0,     1,     3,     0x0B,  0x1B,  0x23,  0x29,  0x2B,  /* 0 */
...
uint8_t lrgo[236] = {
    ...
    /*  3*/ 19,  60,  55,  116, 61,  118, 70,  135, 138, 116, 159, 116, 212, 116, 0,   3,
    ...
    /* 34*/ 0,   129,
    /* 35*/ 0,   130,
    /* 36*/ 87,  153, 111, 196, 121, 200, 130, 202, 0,   162,
    /* 37*/ 0,   67,
    /* 38*/ 0,   120,
    /* 39*/ 0,   68,
    /* 40*/ 0,   21,
    ...
    /* 44*/ 0,   186,
    /* 45*/ 227, 249, 0,   187,
    /* 46*/ 38,  104, 92,  163, 93,  163, 94,  163, 102, 190, 112, 163, 164, 104, 168, 163,
